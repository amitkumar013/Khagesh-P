...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="animate-in slide-in-from-left duration-500">
                <Link
                  href="#home"
                  className="font-bold text-lg lg:text-xl text-primary"
                >
                  Khagesh Kumar
                </Link>
              </div>
      ...
      <section
        id="home"
        className="relative pt-20 lg:pt-24 pb-16 lg:pb-24 bg-gradient-to-br from-muted/50 to-background overflow-hidden"
      >
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-4 lg:space-y-6 animate-in fade-in-50 duration-700 delay-200">
            <Badge
              variant="secondary"
              className="w-fit mx-auto animate-in slide-in-from-top duration-500 delay-400"
            >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-primary leading-tight text-balance">
              <span className="inline-block animate-in slide-in-from-left duration-700 delay-500">
                Building
              </span>{" "}
              <span className="inline-block animate-in slide-in-from-bottom duration-700 delay-600">
                a
              </span>{" "}
              <span className="inline-block animate-in slide-in-from-right duration-700 delay-700 text-accent">
                Better
              </span>{" "}
              <span className="inline-block animate-in slide-in-from-left duration-700 delay-800">
                Tomorrow
              </span>
            ...
            <p className="text-base lg:text-lg text-muted-foreground leading-relaxed text-pretty max-w-3xl mx-auto animate-in fade-in-50 duration-700 delay-1000 px-4 sm:px-0">
              With integrity, vision, and unwavering commitment to public
              service, I stand ready to represent your voice and champion the
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12 lg:mb-16 animate-in fade-in-50 duration-700">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary mb-4 lg:mb-6 text-balance">
              <span className="inline-block animate-in slide-in-from-left duration-600">
                About
              </span>{" "}
            ...
            <p className="text-base lg:text-lg text-muted-foreground leading-relaxed text-pretty animate-in fade-in-50 duration-700 delay-300">
              A dedicated public servant with a proven track record of community
              leadership, policy innovation, and grassroots advocacy for
              positive change.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <Card className="border-border hover:shadow-lg transition-all hover:-translate-y-1 animate-in slide-in-from-bottom duration-700 delay-200">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm lg:text-base">
                  Committed to creating sustainable solutions that address the
                  real challenges facing our community today and tomorrow.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border hover:shadow-lg transition-all hover:-translate-y-1 animate-in slide-in-from-bottom duration-700 delay-400">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm lg:text-base">
                  Every decision is made with the community&apos;s best
                  interests at heart, ensuring transparency and accountability
                  in governance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border hover:shadow-lg transition-all hover:-translate-y-1 animate-in slide-in-from-bottom duration-700 delay-600 sm:col-span-2 lg:col-span-1">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm lg:text-base">
                  A track record of successful initiatives in education,
      ...
      <section id="vision" className="py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12 lg:mb-16 animate-in fade-in-50 duration-700">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary mb-4 lg:mb-6 text-balance">
              <span className="inline-block animate-in slide-in-from-bottom duration-600">
                My Vision for
              </span>{" "}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="space-y-6 animate-in slide-in-from-left duration-700 delay-200">
              <div className="border-l-4 border-accent pl-4 lg:pl-6 hover:pl-6 lg:hover:pl-8 transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm lg:text-base">
                  ...
                  sustainable industries that benefit our entire community.
                </p>
              </div>
              ...
              <div className="border-l-4 border-accent pl-4 lg:pl-6 hover:pl-6 lg:hover:pl-8 transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm lg:text-base">
                  Investing in our schools, teachers, and students to ensure
              ...
              <div className="border-l-4 border-accent pl-4 lg:pl-6 hover:pl-6 lg:hover:pl-8 transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm lg:text-base">
                  Expanding healthcare services and ensuring affordable, quality
            ...
            <div className="space-y-6 animate-in slide-in-from-right duration-700 delay-400">
              <div className="border-l-4 border-accent pl-4 lg:pl-6 hover:pl-6 lg:hover:pl-8 transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm lg:text-base">
                  Upgrading roads, bridges, and public facilities while
                  investing in green technology and sustainability.
                </p>
              </div>
              ...
              <div className="border-l-4 border-accent pl-4 lg:pl-6 hover:pl-6 lg:hover:pl-8 transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm lg:text-base">
                  Ensuring our neighborhoods are safe through community policing
              ...
              <div className="border-l-4 border-accent pl-4 lg:pl-6 hover:pl-6 lg:hover:pl-8 transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm lg:text-base">
                  Protecting our natural resources and promoting sustainable
      ...
      <section id="achievements" className="py-16 lg:py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12 lg:mb-16 animate-in fade-in-50 duration-700">
            ...
            <p className="text-base lg:text-lg text-muted-foreground leading-relaxed text-pretty animate-in fade-in-50 duration-700 delay-300">
              Real achievements that have made a tangible difference in our
              community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <Card className="text-center border-border hover:shadow-lg transition-all hover:-translate-y-2 hover:scale-105 animate-in slide-in-from-bottom duration-700 delay-200">
              <CardContent className="pt-4 lg:pt-6">
                <div className="text-2xl lg:text-3xl font-bold text-accent mb-1 lg:mb-2">
                  500+
                </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
            <Card className="text-center border-border hover:shadow-lg transition-all hover:-translate-y-2 animate-in slide-in-from-bottom duration-700 delay-200">
              <CardContent className="pt-4 lg:pt-6">
                ...
                <h3 className="font-semibold text-card-foreground mb-1 text-sm lg:text-base">
                  Priya Sharma
                </h3>
            ...
            <Card className="text-center border-border hover:shadow-lg transition-all hover:-translate-y-2 animate-in slide-in-from-bottom duration-700 delay-300">
              <CardContent className="pt-4 lg:pt-6">
                ...
                <p className="text-xs text-muted-foreground hidden lg:block">
                  Education and healthcare policy expert
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 opacity-90 leading-relaxed text-pretty">
              Your contribution helps us build a stronger community. Every
              donation, no matter the size, makes a difference in our mission to
              serve the people.
            </p>
            ...
            <p className="text-sm mt-4 opacity-75">
              All donations are secure and go directly towards community
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16 animate-in fade-in-50 duration-700">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Have questions, concerns, or ideas? I want to hear from you.
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card className="border-border hover:shadow-lg transition-all animate-in slide-in-from-right duration-700 delay-400">
                <CardHeader>
                  ...
                  <CardDescription>
                    Share your thoughts, concerns, or suggestions directly with
                    me.
                  </CardDescription>
                </CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center animate-in fade-in-50 duration-700">
            ...
            <p className="text-primary-foreground/80 mb-6">
              Committed to serving our community with integrity, vision, and
              dedication.
            </p>
            <div className="flex justify-center space-x-6 mb-6">
              <Link href="/" className="text-primary-foreground/80 hover:text-primary-foreground transition-all duration-200 hover:scale-110"
              >
                Facebook
              </Link>
              <Link
            ...
            <p className="text-sm text-primary-foreground/60">
              © 2024 Khagesh Kumar. All rights reserved. | Paid for by Friends
              of Khagesh Kumar
            </p>
          </div>
        </div>
